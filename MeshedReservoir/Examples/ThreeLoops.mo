...
equation
  connect(loo2.port_4, loo1.port_1)
    annotation (Line(points={{-16,-20},{-16,-38}}, color={0,127,255}));
  connect(loo2.port_3, loo1.port_2)
    annotation (Line(points={{-12,-20},{-12,-38}}, color={0,127,255}));
  ...
  connect(loo1.m, mTotOth.u[1]) annotation (Line(points={{5,-44},{28,-44},{28,-50.6667},
          {38,-50.6667}}, color={0,0,127}));
  connect(loo2.m, mTotOth.u[2]) annotation (Line(points={{11,-4},{28,-4},{28,-42},
          {30,-42},{30,-50},{38,-50}}, color={0,0,127}));
  connect(loo3.m, mTotOth.u[3]) annotation (Line(points={{17,36},{28,36},{28,-49.3333},
          {38,-49.3333}}, color={0,0,127}));
  connect(mTotOth.y, loo3.mAll) annotation (Line(points={{62,-50},{70,-50},{70,-80},
          {-50,-80},{-50,30},{-22,30}}, color={0,0,127}));
